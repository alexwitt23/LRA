...
/* Created 2018/10/29 00:06:41 awitt $ */
#include "../S_source.hh"
...
double RocketSimObject::call_function_double ( Trick::JobData * curr_job ) {
    ...
    switch ( curr_job->id ) {
        case 4:
            trick_ret = rocket.touch_down(groundAltitude) ;
            break ;
        default:
            trick_ret = 0.0 ;
            break ;
...
IntegLoopSimObject dyn_integloop(0.02, 0, &dyn, (void *)NULL);
...
SimEnvironment::SimEnvironment() {
    ...
    local_env["TRICK_HOST_CPU"] = "Linux__x86_64";
    ...
    local_env["TRICK_USER_CSHRC"] = "/home/awitt/.Trick_user_cshrc";
    setenv("TRICK_USER_CSHRC", local_env["TRICK_USER_CSHRC"].c_str(), 0);
    local_env["TRICK_USER_HOME"] = "/home/awitt/trick_sims";
    ...
    local_env["TRICK_USER_PROFILE"] = "/home/awitt/.Trick_user_profile";
...
void memory_init( void ) {
    ...
    ALLOC_INFO * ai ;
    exec_set_version_date_tag( "@(#)CP Version 17.4.dev, Mon Oct 29 00:06:41 2018" ) ;
    exec_set_build_date( "Mon Oct 29 00:06:41 2018" ) ;
