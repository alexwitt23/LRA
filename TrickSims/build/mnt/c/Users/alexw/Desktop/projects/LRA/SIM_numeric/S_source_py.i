%module m90cba249b503e7b9ed9f0d592ad44d59
...
%{
#include "/mnt/c/Users/alexw/Desktop/projects/LRA/SIM_numeric/S_source.hh"
%}
...
%import "build/mnt/c/Users/alexw/Desktop/projects/LRA/SIM_numeric/models/rocket/include/rocket_py.i"
...
class RocketSimObject : public Trick::SimObject {
    ...
    RocketSimObject() {
            ...
            job = this->add_job(0, 1, "initialization", NULL, 1, "rocket.state_init", "", 60000) ;
            job = this->add_job(0, 2, "derivative", NULL, 1, "rocket.state_deriv", "", 60000) ;
            job = this->add_job(0, 3, "integration", NULL, 1, "rocket.state_integ", "", 60000) ;
            job = this->add_job(0, 4, "dynamic_event", NULL, 1, "rocket.touch_down", "", 60000) ;
    }
