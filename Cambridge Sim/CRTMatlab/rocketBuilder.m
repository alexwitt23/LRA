...
building = true;
while building 
    %%%%% USE SWITCH CASE SYSTEM TO BUILD
    %%%%% FOR MULTIPLE USES OF ONE COMPONENT, MAKE SURE SOME METHOD OF
    %%%%% CHECLKING FOR PREVIOUS
...
switch n
    ...
    case 2 % cylinders
        ...
        %{
            %% CYLINDERS
            c={�cylinder�,�yes�,L,d,M,X} % the string �yes� identi?es that the outer surface of the cylinder forms part of the rocket�s body surface
            L: length
            d: diameter
            M: mass in kg
...
c1 = {'cylinder',out,str2num(length),str2num(diameter),str2num(mass),str2num(pos)};
