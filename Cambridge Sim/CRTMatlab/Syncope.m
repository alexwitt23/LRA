...
%(DROGUE)
p1 = {'parachute',1.5,.292246657,.0244,1.24};
%(MAIN)
p2 = {'parachute',1.89,1.81458,.363,.914};
%%%%%%%%%%%%%%%%%%
...
INTAB = intab_builder(n1,c1,c2,t1,t2,t3,t4,t5,pm1,pm2,p1,p2,f1,Motor);
%% Simulation 
%load atmospheric data
load('intab4_2006100815.mat');
...
Rb = 40;
[Asc,Des,Landing,Apogee] = rocketflight_monte(INTAB,INTAB4,altpd,R1,Ra,Rb,noi)
